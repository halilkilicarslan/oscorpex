...
export const calculatorTool = createTool({
  ...
  parameters: z.object({
    operation: z
      ...
      .describe(
        "The operation to perform. Use 'evaluate' to parse a full expression string."
      ),
    expression: z
      .string()
      .optional()
      .describe(
        "A mathematical expression string (e.g. '3 + 4 * 2'). Required when operation is 'evaluate'."
      ),
    a: z
      .number()
      .optional()
      .describe("The first operand. Required for add/subtract/multiply/divide."),
    b: z
      .number()
      .optional()
      .describe(
        "The second operand. Required for add/subtract/multiply/divide."
      ),
  }),
  execute: async ({ operation, expression, a, b }) => {
    ...
    if (a === undefined || b === undefined) {
      throw new Error(
        `Both 'a' and 'b' are required for the '${operation}' operation.`
      );
    }
