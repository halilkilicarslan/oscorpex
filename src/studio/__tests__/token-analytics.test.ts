...
describe('Token Analytics (Faz 3.1)', () => {
  ...
  it('TokenUsage should include cache token fields', () => {
    const usage: TokenUsage = {
      id: 'test', projectId: 'p1', taskId: 't1', agentId: 'a1',
  ...
  it('ProjectCostSummary should include cache totals', () => {
    const summary: ProjectCostSummary = {
      totalCostUsd: 1.5, totalInputTokens: 10000, totalOutputTokens: 5000,
      totalTokens: 15000, taskCount: 5,
      totalCacheCreationTokens: 2000, totalCacheReadTokens: 3000,
    };
