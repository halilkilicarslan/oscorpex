...
class GitManager {
	 ...
	 */
	async mergeBranch(projectPath: string, sourceBranch: string, targetBranch: string): Promise<MergeResult> {
	 ...
	 */
	async getCommitLog(projectPath: string, limit = 20): Promise<GitLogEntry[]> {
