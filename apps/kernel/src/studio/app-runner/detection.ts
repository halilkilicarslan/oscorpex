// ---------------------------------------------------------------------------
// app-runner/detection.ts — Config and language detection
// (.studio.json, docker-compose, auto-detect by language/framework)
// ---------------------------------------------------------------------------

import { existsSync, readFileSync } from "node:fs";
import { join } from "node:path";
import { RESERVED_PORTS } from "./port-manager.js";
import type { LangDetection, ServiceConfig, StudioConfig } from "./types.js";

// ---------------------------------------------------------------------------
// Detection — .studio.json
// ---------------------------------------------------------------------------

export function loadStudioConfig(repoPath: string): StudioConfig | null {
...
export function detectDockerCompose(repoPath: string): StudioConfig | null {
...
export function detectLanguage(dirPath: string, dirName: string): LangDetection | null {
	// Node.js
...
export function autoDetect(repoPath: string): StudioConfig | null {
 ...
 * 1. settingsOverride (from DB project settings)
 * 2. .studio.json
