// ---------------------------------------------------------------------------
// LoginPage — Dark theme login form
// ---------------------------------------------------------------------------
		...
		<div className="flex min-h-screen items-center justify-center bg-[#0a0a0a] px-4">
			<div className="w-full max-w-sm">
				...
				<div className="bg-[#111111] border border-[#262626] rounded-xl p-7">
					<h1 className="text-lg font-semibold text-[#fafafa] mb-1">Sign in to Oscorpex</h1>
					<p className="text-sm text-[#737373] mb-6">Enter your credentials to continue</p>
