...
function TemplateCard({ template, onEdit, onDuplicate, onDelete, onCopy, onViewHistory }: TemplateCardProps) {
...
function VersionHistoryPanel({ templateId, onClose }: { templateId: string; onClose: () => void }) {
					...
					<>
						<div className="flex items-center justify-between mb-4">
							<p className="text-[12px] text-[#525252]">
								...
								{tagFilter && (
									<span className="ml-1">tagged <span className="text-[#a3a3a3]">{tagFilter}</span></span>
								)}
							</p>
						</div>
