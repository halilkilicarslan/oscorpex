...
const sections: NavSection[] = [
	{
		title: "",
		items: [{ to: "/", label: "Agents & Workflows", icon: <LayoutGrid size={18} /> }],
	},
	{
		title: "OBSERVABILITY",
		items: [
	...
	{
		title: "AUTOMATION",
		items: [{ to: "/triggers", label: "Triggers", icon: <Workflow size={18} />, badge: "New" }],
	},
	{
		title: "OSCORPEX",
		collapsible: true,
		items: [
			...
			{ to: "/studio/skills", label: "Skills", icon: <Sparkles size={18} />, badge: "New" },
					...
					<div key={section.title || "main"} className="mb-2">
						{section.title && !collapsed && (
							<div className="flex items-center justify-between px-2 mb-1">
								...
								{section.collapsible && (
									<button onClick={() => toggleSection(section.title)} className="text-[#525252] hover:text-[#737373]">
										<ChevronDown
											size={12}
